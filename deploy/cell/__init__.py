...
The pose pipeline (``src/``) and the pose service (``deploy/pose_service/``)
...
in the OpenCV camera convention, and every module runs its own
verification under ``python -m deploy.cell.<module>``.
"""
