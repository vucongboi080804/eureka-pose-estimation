...
board's bare Python without the estimator's environment.
    ...
    python -m deploy.pose.client estimate --scene test/000001
    python -m deploy.pose.client estimate --scene test/000001 --inline
    python -m deploy.pose.client health
    python -m deploy.pose.client metrics
    python -m deploy.pose.client bench-frame --scene test/000001 -n 10
